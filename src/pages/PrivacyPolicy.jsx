...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      ...
      <p className="mb-4">
        At StyleSync, we are committed to protecting your privacy and ensuring the security of your personal information. This privacy policy explains how we collect, use, and safeguard your data when you visit our website or make a purchase from our store.
      </p>
      ...
      <p className="mb-4">
        ...
        <ul className="list-disc ml-8">
          ...
          <li><strong>Legal Obligations:</strong> We may disclose your information if required by law or to protect the rights of StyleSync and others.</li>
        </ul>
      </p>
      ...
      <p className="mb-4">
        ...
        To exercise any of these rights, please contact us at <a href="mailto:privacy@stylesync.com" className="text-blue-600 underline">privacy@stylesync.com</a>.
      </p>
      ...
      <p className="mb-4">
        ...
        <br />
        Email: <a href="mailto:privacy@stylesync.com" className="text-blue-600 underline">privacy@stylesync.com</a>
        <br />
        Phone: +880-XXX-XXXX
      </p>
